# 🎯 3 NET RAKAM KARTI - HİZALAMALI VE RENKLENDİRİLMİŞ
            ...
            with col1:
                ...
                if islem_durumu == "al":
                    st.markdown(f'<div style="font-size: 26px !important; font-weight: 900 !important; color: #22c55e !important;">ALINIR</div>', unsafe_allow_html=True)
                elif islem_durumu == "alma":
                    st.markdown(f'<div style="font-size: 26px !important; font-weight: 900 !important; color: #ef4444 !important;">ALINMAZ</div>', unsafe_allow_html=True)
                else:
                    st.markdown(f'<div style="font-size: 26px !important; font-weight: 900 !important; color: #fbbf24 !important;">BEKLE</div>', unsafe_allow_html=True)
